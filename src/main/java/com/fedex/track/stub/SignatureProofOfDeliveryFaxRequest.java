...
public class SignatureProofOfDeliveryFaxRequest  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "SignatureProofOfDeliveryFaxRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "FaxSender"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "FaxRecipient"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "ContactAndAddress"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
