...
public class SignatureProofOfDeliveryFaxReply  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "SignatureProofOfDeliveryFaxReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "FaxConfirmationNumber"));
