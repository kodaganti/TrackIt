...
public class SignatureProofOfDeliveryLetterRequest  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "SignatureProofOfDeliveryLetterRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "QualifiedTrackingNumber"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "QualifiedTrackingNumber"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("additionalComments");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "AdditionalComments"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "LetterFormat"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "SignatureProofOfDeliveryImageType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("consignee");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v6", "Consignee"));
